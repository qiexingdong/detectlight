	...
	case UART_1:  //若为串口1
		...
		case 0:
			...
			GPIOA->AFR[1] |= ((GPIO_AFRH_AFSEL9_0 
					      ...
					      |(GPIO_AFRH_AFSEL10_0 | GPIO_AFRH_AFSEL10_1 
					      | GPIO_AFRH_AFSEL10_2));
			break;
		case 1:
			//使能USART1和GPIOB时钟
			...
			GPIOB->AFR[0] |= ((GPIO_AFRL_AFSEL6_0 
			              | GPIO_AFRL_AFSEL6_1 | GPIO_AFRL_AFSEL6_2)
					      |(GPIO_AFRL_AFSEL7_0 | GPIO_AFRL_AFSEL7_1 
					      | GPIO_AFRL_AFSEL7_2));
			break;
		default:
			break;
	...
	case UART_2:  //若为串口2
		...
		case 0:
			...
			GPIOA->AFR[0] |= ((GPIO_AFRL_AFSEL2_0 
			              | GPIO_AFRL_AFSEL2_1 | GPIO_AFRL_AFSEL2_2)
	...
	case UART_3:  //若为串口3
		...
		case 0:
			...
			GPIOB->AFR[1] |= ((GPIO_AFRH_AFSEL10_0 
					      ...
					      |(GPIO_AFRH_AFSEL11_0 | GPIO_AFRH_AFSEL11_1 
					      | GPIO_AFRH_AFSEL11_2));
			break;
		case 1:
			//使能USART3和GPIOC时钟
...
void uart_enable_re_int(uint8_t uartNo)
{
	...
	NVIC_EnableIRQ(table_irq_uart[uartNo-1]);        //开放IRQ中断
}
...
void uart_disable_re_int(uint8_t uartNo)
{
	...
	NVIC_DisableIRQ(table_irq_uart[uartNo-1]);         //禁止IRQ中断
}  
...
uint8_t uart_get_re_int(uint8_t uartNo)
{
	...
	if(((USART_ARR[uartNo-1]->ISR & USART_ISR_RXNE_Msk) 
	        == USART_ISR_RXNE_Msk)
			&& ((USART_ARR[uartNo-1]->CR1 & USART_CR1_RXNEIE_Msk) 
